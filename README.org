...
- [[file:core/aiddl/eval.aiddl][eval.aiddl]] :: short names for predefined functions
- [[file:core/aiddl/eval-ht.aiddl][eval-ht.aiddl]] :: same as eval.aiddl but uses names prefaced by a hashtag
