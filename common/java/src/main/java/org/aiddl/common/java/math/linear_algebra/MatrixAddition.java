...
public class MatrixAddition implements Function {
	@Override
	public Term apply( Term args ) {
		...
		if ( m_A != m_B || n_A != n_B ) {
			throw new IllegalArgumentException(String.format("Cannot add %dx%d matrix to %dx%d matrix (dimensions must match).", m_A, n_A, m_B, n_B));
		}
