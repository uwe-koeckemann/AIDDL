...
public class Uri {
    ...
    public static final SymbolicTerm TYPE_EREF = Term.sym("org.aiddl.type.term.ref.entry");
    public static final SymbolicTerm TYPE_FREF = Term.sym("org.aiddl.type.term.ref.function");
