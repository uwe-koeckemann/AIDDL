 ...
 */
public class FilterFunction implements LazyFunction, ConfigurableFunction {
	 ...
	 */
	public FilterFunction( Evaluator main ) {
		this.eval = main;
	}
	...
	public Term apply(Term x) {		
		...
		for ( Term e : C ) {
			if ( f.apply(e).getBooleanValue() ) {
				C_m.add(e);
			}
//			Substitution s = var.match(e);
//			if ( s != null ) {
//				Term r = this.eval.compute(f.substitute(s));
//				if ( r.equals(Term.bool(true)) ) {
//					C_m.add(e);
//				}
//			}
		}
