...
public class AIDDLParser implements AIDDLParserConstants {
  ...
  final public Term DomainDefinition(Container db, FunctionRegistry freg) throws ParseException {
  Term module = null;
  Term modAlias = null;
  Term type = null;
  ...
  final public void Entry(Term module, Container db, FunctionRegistry freg) throws ParseException {
  Term type;
  Term name;
  Term content;
  Term compiledModule;
  ...
  final public Term Term(Container db, FunctionRegistry freg) throws ParseException {
  Term term;
  Term value = null;
  ...
  int base = 10;
    ...
    {if (true) return Term.integer(Long.parseLong(s, base));}
    throw new Error("Missing return statement in function");
  }

  final public Term RationalTerm() throws ParseException {
  Token t;
    t = jj_consume_token(RATIONAL);
    Long p = Long.valueOf(t.image.split("/")[0]);
    Long q = Long.valueOf(t.image.split("/")[1]);
    {if (true) return Term.rational(p,q);}
    throw new Error("Missing return statement in function");
  }

  final public Term RealTerm() throws ParseException {
  Token t;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case REAL:
    ...
    {if (true) return Term.real(Double.valueOf(t.image));}
    throw new Error("Missing return statement in function");
  }

  final public Term InfTerm() throws ParseException {
  Token inf_token;
    inf_token = jj_consume_token(INF);
    if ( inf_token.image.startsWith("-") )
      {if (true) return Term.infNeg();}
    else
      {if (true) return Term.infPos();}
    throw new Error("Missing return statement in function");
  }

  final public Term NanTerm() throws ParseException {
    jj_consume_token(NAN);
    {if (true) return Term.nan();}
    throw new Error("Missing return statement in function");
  }

  final public Term SymbolicTerm() throws ParseException {
  Token t;
    t = jj_consume_token(SYMBOL);
    {if (true) return Term.sym(t.image);}
    throw new Error("Missing return statement in function");
  }
  ...
  Token t;
    ...
    {if (true) return Term.string(t.image);}
    throw new Error("Missing return statement in function");
  }

  final public Term VariableTerm() throws ParseException {
  Token t;
    t = jj_consume_token(VARIABLE);
    if ( Parser.getCurrentModule().getStringValue() == null ) {
      {if (true) return Term.var(t.image);}
    } else {
      {if (true) return Term.var(t.image, Parser.getCurrentModule().getStringValue());}
    }
    throw new Error("Missing return statement in function");
  }

  final public Term SelfReferenceTerm(Container db, FunctionRegistry freg) throws ParseException {
  Term t;
    ...
    {if (true) return Term.ref(t, selfAlias, Parser.getCurrentModule());}
    throw new Error("Missing return statement in function");
  }

  final public Term ExtReferenceTerm(Container db, FunctionRegistry freg) throws ParseException {
  Term name;
  Term module;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case SYMBOL:
    ...
    if ( resolvedModName != null ) {
      {if (true) return Term.ref(name, module, resolvedModName);}
    } else {
      {if (true) return Term.ref(name, module);}
    }
    throw new Error("Missing return statement in function");
  }

  final public Term FunctionReferenceTerm(Container db, FunctionRegistry freg) throws ParseException {
  Term t;
    if (jj_2_7(2)) {
      jj_consume_token(FREF);
      t = SelfReferenceTerm(db, freg);
                                                {if (true) return Term.fref(t.asRef(), freg);}
    } else {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case FREF:
        if (jj_2_6(3)) {
          ...
          case FREF:
            jj_consume_token(FREF);
            t = SymbolicTerm();
                                   {if (true) return Term.fref(t.asSym(), freg);}
            break;
          default:
            jj_la1[9] = jj_gen;
            jj_consume_token(-1);
  ...
  final public TupleTerm TupleTerm(Container db, FunctionRegistry freg) throws ParseException {
  Term term;
  List<Term> L;
    jj_consume_token(OTUPLE);
    ...
    jj_consume_token(CTUPLE);
      ...
      {if (true) return Term.tuple(L_array);}
    throw new Error("Missing return statement in function");
  }

  final public Term ListTerm(Container db, FunctionRegistry freg) throws ParseException {
  Term term;
  List<Term> L;
    ...
    jj_consume_token(CLIST);
      ...
      {if (true) return Term.list(L_array);}
    throw new Error("Missing return statement in function");
  }

  final public SetTerm SetTerm(Container db, FunctionRegistry freg) throws ParseException {
  Term term;
  List<Term> L;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x80,0x40a00,0x7f0cca80,0x30000000,0x2000,0xf00000,0x2080000,0x10000080,0x10000080,0x8000,0x8000,0x7ffcca80,0x7ffcca80,0x7ffcca80,};
   }
