...
CALL_REQUEST = Sym("org.aiddl.eval.call-request")
...
EVAL_REF = Sym("org.aiddl.eval.eval-ref")
SIGNATURE = Sym("org.aiddl.eval.signature")
...
TYPE_REF = Sym("org.aiddl.type.term.reference")
TYPE_FREF = Sym("org.aiddl.type.term.fun-ref")
