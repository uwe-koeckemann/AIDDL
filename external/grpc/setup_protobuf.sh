...
sed -i 's/import sensor/from . import sensor/g' protobuf/generated/*.py
...
rm scala/src/main/protobuf/sensor.proto
...
cp protobuf/sensor.proto scala/src/main/protobuf/sensor.proto
